...
public class TaskServiceTest {
	...
	public void testDeleteTask() {
		...
		// When
		taskService.deleteTask(dto.getSpaceKey(), dto.getTaskNo());
		
		// Then
	}
	
	// 3. 해당 스페이스 TaskList 조회 테스트
	@Test
	public void testShowTaskList() {
		...
		// When
		List<TaskInfoDto> list = taskService.showTaskList(currentSpaceKey);
	...
	public void testShowUpperTaskList() {
		...
		// When
		List<TaskInfoDto> list = taskService.showUpperTaskList(currentSpaceKey);
	...
	public void testShowLowerTaskList() {
		...
		// When
		List<TaskInfoDto> list = taskService.showLowerTaskList(dto1);
	...
	public void testUpdateTask() {
		...
		dto.setSpaceKey("ABCD");
		dto.setTaskNo(8);
		dto.setTaskDescription("김치찌개 먹기");
	...
	public void testSearchTask() {
		...
		dto.setSearchDueDate("2026-06-05");
		
		// When
		List<TaskInfoDto> taskList = taskService.searchTask(dto);
	...
	public void testUpdateTaskOrder() {
		...
		// When
		boolean chk = taskService.updateTaskOrder(dto);
