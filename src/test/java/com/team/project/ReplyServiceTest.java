...
public class ReplyServiceTest {
	...
	public void testWriteReply() {
		...
		dto.setImageNo(2);
		// When
		boolean isWrited = rSvc.WriteReply(dto);
		// Then
	...
	public void testUpdateReply() {
		...
		dto.setReplyNo(1);
		// When
		boolean isUpdated = rSvc.UpdateReply(dto);
		// Then
	...
	public void testDeleteReply() {
		...
		dto.setWriterNo(1);
		// When
		boolean isDeleted = rSvc.DeleteReply(dto);
		// Then
	...
	public void testChangeOrderDown() {
		...
		dto.setTaskNo(1);
		// When
		List<ReplyListDto> list = rSvc.ShowReplyList(dto);
		// Then
