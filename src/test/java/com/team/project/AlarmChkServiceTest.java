...
public class AlarmChkServiceTest {
	@Autowired
	AlarmChkService alarmchkSvc;
	...
	public void testCreateAlarmCheck() {
		...
		dto.setUser_no(2);
		// When
		boolean isCreated = alarmchkSvc.CreateAlarmCheck(dto);
		// Then
	...
	public void testDeleteAlarmCheck() {
		...
		dto.setUser_no(2);
		// When
		boolean isDeleted = alarmchkSvc.DeleteAlarmCheck(dto);
		// Then
	...
	public void testCountAlarXtmCheck() {
		...
		int user_no = 1;
		// When
		int cnt = alarmchkSvc.CountAlarmCheck(user_no);
		// Then
