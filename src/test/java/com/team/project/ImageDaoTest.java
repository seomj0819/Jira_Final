...
public class ImageDaoTest {
	...
	public void testUploadImage() {
		...
		dto.setImage_title("testImage4444");
		dto.setImage_category("user");
		// When
		boolean isUploaded = imageDao.UploadImage(dto);
		// Then
	...
	public void testUpdateProfileImage() {
		// Given
		String new_image_title ="newTestImageTitle1234";
		int user_no = 1;
		Map<String, Object> paramMap = new HashMap<>();
		paramMap.put("new_image_title", new_image_title);
		paramMap.put("user_no", user_no);
		// When
		boolean isUpdated = imageDao.UpdateProfileImage(paramMap);
		// Then
	...
	public void testDeleteImageReply() {
		...
		paramMap.put("user_no", user_no);
		// When
		boolean isDeleted = imageDao.DeleteImageReply(paramMap);
		// Then
	...
	public void testDeleteImageTask() {
		...
		paramMap.put("user_no", user_no);
		// When
		boolean isDeleted = imageDao.DeleteImageTask(paramMap);
		// Then
		assertTrue("failed", isDeleted);
	}
	...
	public void testDeleteImageProfile() {
		...
		int quit_user_no = 1;
		// When
		boolean isDeleted = imageDao.DeleteImageProfile(quit_user_no);
		// Then
		assertTrue("failed", isDeleted);
	}
}
